...
entity ps7_stub is
	...
	--
	ftmt_f2p_debug	: in std_logic_vector (31 downto 0)	:= (others => '0');
	...
	--
	spi0_miso_i	: in std_ulogic				:= '0';
	spi0_miso_o	: out std_ulogic;
	spi0_miso_t_n	: out std_ulogic;
	--
	spi0_mosi_i	: in std_ulogic				:= '0';
	spi0_mosi_o	: out std_ulogic;
	spi0_mosi_t_n	: out std_ulogic;
	--
	spi0_sclk_i	: in std_ulogic				:= '0';
	spi0_sclk_o	: out std_ulogic;
	spi0_sclk_t_n	: out std_ulogic;
	--
	spi0_ss_i	: in std_ulogic				:= '0';
	spi0_ss_o	: out std_logic_vector (2 downto 0);
	spi0_ss_t_n	: out std_ulogic;
	--
	spi1_miso_i	: in std_ulogic				:= '0';
	spi1_miso_o	: out std_ulogic;
	spi1_miso_t_n	: out std_ulogic;
	--
	spi1_mosi_i	: in std_ulogic				:= '0';
	spi1_mosi_o	: out std_ulogic;
	spi1_mosi_t_n	: out std_ulogic;
	--
	spi1_sclk_i	: in std_ulogic				:= '0';
	spi1_sclk_o	: out std_ulogic;
	spi1_sclk_t_n	: out std_ulogic;
	--
	spi1_ss_i	: in std_ulogic				:= '0';
	spi1_ss_o	: out std_logic_vector (2 downto 0);
	spi1_ss_t_n	: out std_ulogic;
	--
...
begin
	...
	EMIOSPI0MO			=> spi0_mosi_o,		-- out std_ulogic;
	EMIOSPI0MOTN			=> spi0_mosi_t_n,	-- out std_ulogic;
	EMIOSPI0SCLKO			=> spi0_sclk_o,		-- out std_ulogic;
	EMIOSPI0SCLKTN			=> spi0_sclk_t_n,	-- out std_ulogic;
	EMIOSPI0SO			=> spi0_miso_o,		-- out std_ulogic;
	EMIOSPI0SSNTN			=> spi0_ss_t_n,		-- out std_ulogic;
	EMIOSPI0SSON			=> spi0_ss_o,		-- out std_logic_vector (2 downto 0);
	EMIOSPI0STN			=> spi0_miso_t_n,	-- out std_ulogic;
	EMIOSPI1MO			=> spi1_mosi_o,		-- out std_ulogic;
	EMIOSPI1MOTN			=> spi1_mosi_t_n,	-- out std_ulogic;
	EMIOSPI1SCLKO			=> spi1_sclk_o,		-- out std_ulogic;
	EMIOSPI1SCLKTN			=> spi1_sclk_t_n,	-- out std_ulogic;
	EMIOSPI1SO			=> spi1_miso_o,		-- out std_ulogic;
	EMIOSPI1SSNTN			=> spi1_ss_t_n,		-- out std_ulogic;
	EMIOSPI1SSON			=> spi1_ss_o,		-- out std_logic_vector (2 downto 0);
	EMIOSPI1STN			=> spi1_miso_t_n,	-- out std_ulogic;
	...
	FTMTP2FDEBUG			=> ftmt_p2f_debug,	-- out std_logic_vector (31 downto 0);
	...
	EMIOSPI0MI			=> spi0_miso_i,		-- in std_ulogic;
	EMIOSPI0SCLKI			=> spi0_sclk_i,		-- in std_ulogic;
	EMIOSPI0SI			=> spi0_mosi_i,		-- in std_ulogic;
	EMIOSPI0SSIN			=> spi0_ss_i,		-- in std_ulogic;
	EMIOSPI1MI			=> spi1_miso_i,		-- in std_ulogic;
	EMIOSPI1SCLKI			=> spi1_sclk_i,		-- in std_ulogic;
	EMIOSPI1SI			=> spi1_mosi_i,		-- in std_ulogic;
	EMIOSPI1SSIN			=> spi1_ss_i,		-- in std_ulogic;
	...
	FTMTF2PDEBUG			=> ftmt_f2p_debug,	-- in std_logic_vector (31 downto 0);
